...
var controllerKind = clusterv1beta1.SchemeGroupVersion.WithKind("MachineSet")
...
func add(mgr manager.Manager, r reconcile.Reconciler, mapFn handler.ToRequestsFunc) error {
	...
	err = c.Watch(&source.Kind{Type: &clusterv1beta1.MachineSet{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(
		...
		&handler.EnqueueRequestForOwner{IsController: true, OwnerType: &clusterv1beta1.MachineSet{}},
	)
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=cluster.openshift.io,resources=machinesets,verbs=get;list;watch;create;update;patch;delete
...
func (r *ReconcileMachineSet) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	allMachines := &clusterv1beta1.MachineList{}
	...
	var filteredMachines []*clusterv1beta1.Machine
...
func (c *ReconcileMachineSet) syncReplicas(ms *clusterv1beta1.MachineSet, machines []*clusterv1beta1.Machine) error {
	...
	if diff < 0 {
		...
		var machineList []*clusterv1beta1.Machine
		...
		for _, machine := range machinesToDelete {
			go func(targetMachine *clusterv1beta1.Machine) {
				defer wg.Done()
...
func (c *ReconcileMachineSet) createMachine(machineSet *clusterv1beta1.MachineSet) *clusterv1beta1.Machine {
...
func shouldExcludeMachine(machineSet *clusterv1beta1.MachineSet, machine *clusterv1beta1.Machine) bool {
...
func (c *ReconcileMachineSet) adoptOrphan(machineSet *clusterv1beta1.MachineSet, machine *clusterv1beta1.Machine) error {
...
func (c *ReconcileMachineSet) waitForMachineCreation(machineList []*clusterv1beta1.Machine) error {
...
func (c *ReconcileMachineSet) waitForMachineDeletion(machineList []*clusterv1beta1.Machine) error {
	for _, machine := range machineList {
		pollErr := util.Poll(stateConfirmationInterval, stateConfirmationTimeout, func() (bool, error) {
			m := &clusterv1beta1.Machine{}
			err := c.Client.Get(context.Background(),
