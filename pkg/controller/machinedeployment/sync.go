...
// are paused.
func (r *ReconcileMachineDeployment) sync(d *clusterv1beta1.MachineDeployment, msList []*clusterv1beta1.MachineSet, machineMap map[types.UID]*clusterv1beta1.MachineList) error {
...
func (r *ReconcileMachineDeployment) getAllMachineSetsAndSyncRevision(d *clusterv1beta1.MachineDeployment, msList []*clusterv1beta1.MachineSet, machineMap map[types.UID]*clusterv1beta1.MachineList, createIfNotExisted bool) (*clusterv1beta1.MachineSet, []*clusterv1beta1.MachineSet, error) {
...
func (r *ReconcileMachineDeployment) getNewMachineSet(d *clusterv1beta1.MachineDeployment, msList, oldMSs []*clusterv1beta1.MachineSet, createIfNotExisted bool) (*clusterv1beta1.MachineSet, error) {
	...
	if existingNewMS != nil {
		...
		err := r.updateMachineDeployment(d, func(innerDeployment *clusterv1beta1.MachineDeployment) {
	...
	newMS := clusterv1beta1.MachineSet{
...
func (r *ReconcileMachineDeployment) scale(deployment *clusterv1beta1.MachineDeployment, newMS *clusterv1beta1.MachineSet, oldMSs []*clusterv1beta1.MachineSet) error {
...
func (r *ReconcileMachineDeployment) syncDeploymentStatus(allMSs []*clusterv1beta1.MachineSet, newMS *clusterv1beta1.MachineSet, d *clusterv1beta1.MachineDeployment) error {
...
func calculateStatus(allMSs []*clusterv1beta1.MachineSet, newMS *clusterv1beta1.MachineSet, deployment *clusterv1beta1.MachineDeployment) clusterv1beta1.MachineDeploymentStatus {
	...
	status := clusterv1beta1.MachineDeploymentStatus{
		// TODO: Ensure that if we start retrying status updates, we won't pick up a new Generation value.
		ObservedGeneration:  deployment.Generation,
		Replicas:            dutil.GetActualReplicaCountForMachineSets(allMSs),
		UpdatedReplicas:     dutil.GetActualReplicaCountForMachineSets([]*clusterv1beta1.MachineSet{newMS}),
...
func (r *ReconcileMachineDeployment) scaleMachineSet(ms *clusterv1beta1.MachineSet, newScale int32, deployment *clusterv1beta1.MachineDeployment) (bool, error) {
	if ms.Spec.Replicas == nil {
...
func (r *ReconcileMachineDeployment) scaleMachineSetOperation(ms *clusterv1beta1.MachineSet, newScale int32, deployment *clusterv1beta1.MachineDeployment, scaleOperation string) (bool, error) {
	if ms.Spec.Replicas == nil {
		return false, fmt.Errorf("spec replicas for machine set %v is nil, this is unexpected", ms.Name)
	}
...
func (r *ReconcileMachineDeployment) cleanupDeployment(oldMSs []*clusterv1beta1.MachineSet, deployment *clusterv1beta1.MachineDeployment) error {
	if deployment.Spec.RevisionHistoryLimit == nil {
		return nil
	}

	// Avoid deleting machine set with deletion timestamp set
	aliveFilter := func(ms *clusterv1beta1.MachineSet) bool {
...
// msList should come from getMachineSetsForDeployment(d).
// machineMap should come from getMachineMapForDeployment(d, msList).
func (r *ReconcileMachineDeployment) isScalingEvent(d *clusterv1beta1.MachineDeployment, msList []*clusterv1beta1.MachineSet, machineMap map[types.UID]*clusterv1beta1.MachineList) (bool, error) {
...
func (r *ReconcileMachineDeployment) updateMachineDeployment(d *clusterv1beta1.MachineDeployment, modify func(*clusterv1beta1.MachineDeployment)) error {
	return updateMachineDeployment(r.Client, d, modify)
}

// We have this as standalone variant to be able to use it from the tests
func updateMachineDeployment(c client.Client, d *clusterv1beta1.MachineDeployment, modify func(*clusterv1beta1.MachineDeployment)) error {
	dCopy := d.DeepCopy()
	modify(dCopy)
	...
	err := retry.RetryOnConflict(retry.DefaultBackoff, func() error {
		...
		clusterv1beta1.PopulateDefaultsMachineDeployment(d)
		// Apply modifications
		modify(d)
