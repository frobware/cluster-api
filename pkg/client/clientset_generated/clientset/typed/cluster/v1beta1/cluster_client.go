...
// ClusterV1beta1Client is used to interact with features provided by the cluster.openshift.io group.
...
func (c *ClusterV1beta1Client) MachineClasses(namespace string) MachineClassInterface {
	return newMachineClasses(c, namespace)
}

func (c *ClusterV1beta1Client) MachineDeployments(namespace string) MachineDeploymentInterface {
	return newMachineDeployments(c, namespace)
}

func (c *ClusterV1beta1Client) MachineSets(namespace string) MachineSetInterface {
