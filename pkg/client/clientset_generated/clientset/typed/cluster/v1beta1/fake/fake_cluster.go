...
var clustersResource = schema.GroupVersionResource{Group: "cluster.k8s.io", Version: "v1beta1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "cluster.k8s.io", Version: "v1beta1", Kind: "Cluster"}
