...
var machinesResource = schema.GroupVersionResource{Group: "cluster.k8s.io", Version: "v1beta1", Resource: "machines"}

var machinesKind = schema.GroupVersionKind{Group: "cluster.k8s.io", Version: "v1beta1", Kind: "Machine"}
