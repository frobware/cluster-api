...
var machinesResource = schema.GroupVersionResource{Group: "cluster.openshift.io", Version: "v1beta1", Resource: "machines"}

var machinesKind = schema.GroupVersionKind{Group: "cluster.openshift.io", Version: "v1beta1", Kind: "Machine"}

// Get takes name of the machine, and returns the corresponding machine object, and an error if there is any.
func (c *FakeMachines) Get(name string, options v1.GetOptions) (result *v1beta1.Machine, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachines) List(opts v1.ListOptions) (result *v1beta1.MachineList, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachines) Create(machine *v1beta1.Machine) (result *v1beta1.Machine, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachines) Update(machine *v1beta1.Machine) (result *v1beta1.Machine, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachines) UpdateStatus(machine *v1beta1.Machine) (*v1beta1.Machine, error) {
	obj, err := c.Fake.
...
func (c *FakeMachines) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(machinesResource, c.ns, name), &v1beta1.Machine{})
