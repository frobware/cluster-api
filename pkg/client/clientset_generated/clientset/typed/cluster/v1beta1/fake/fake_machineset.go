...
var machinesetsResource = schema.GroupVersionResource{Group: "cluster.k8s.io", Version: "v1beta1", Resource: "machinesets"}

var machinesetsKind = schema.GroupVersionKind{Group: "cluster.k8s.io", Version: "v1beta1", Kind: "MachineSet"}
