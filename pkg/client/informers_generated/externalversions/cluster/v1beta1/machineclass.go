...
import (
	...
	v1beta1 "github.com/openshift/cluster-api/pkg/client/listers_generated/cluster/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterV1beta1().MachineClasses(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterV1beta1().MachineClasses(namespace).Watch(options)
			},
		},
		&clusterv1beta1.MachineClass{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *machineClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusterv1beta1.MachineClass{}, f.defaultInformer)
}
